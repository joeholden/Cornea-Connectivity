...
IMG_DIR = '/Users/joemattholden/Desktop/all binary'
...
def process_image(path):
    ...
    return len(colors), white_area, white
...
for root, dirs, files in os.walk(IMG_DIR):
    for f in files:
        if f.endswith('.png') or f.endswith('.tif'):
            ...
            frags, w_area, white = process_image(IMG_DIR + f'/{f}')
            data.append((f, frags, w_area, white))
